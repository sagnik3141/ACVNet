...
parser.add_argument('--dataset', default='kitti_spc', help='dataset name', choices=__datasets__.keys())
parser.add_argument('--datapath', default='/data/sagnik/kitti_spc/', help='data path')
parser.add_argument('--num_frames', default=75, help='num frames avg short exp')
...
parser.add_argument('--loadckpt', default='checkpoints/base_single_1/checkpoint_000599.ckpt', help='load the weights from a specific checkpoint')
...
train_dataset = StereoDataset(args.datapath, args.trainlist, args.num_frames, True)
test_dataset = StereoDataset(args.datapath, args.testlist, args.num_frames, True)
